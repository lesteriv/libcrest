...
${OBJECTDIR}/_ext/1642614647/cr_event_loop.o: ../slite/src/third/libcrest/src/cr_event_loop.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -m64 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1642614647/cr_event_loop.o ../slite/src/third/libcrest/src/cr_event_loop.cpp
