...
${OBJECTDIR}/third/mongoose/cr_event_loop.o: third/mongoose/cr_event_loop.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -m64 -MMD -MP -MF $@.d -o ${OBJECTDIR}/third/mongoose/cr_event_loop.o third/mongoose/cr_event_loop.cpp
