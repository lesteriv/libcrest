...
# CC Compiler Flags
CCFLAGS=-fno-exceptions -fno-rtti -flto -Ofast
CXXFLAGS=-fno-exceptions -fno-rtti -flto -Ofast
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/server: ${OBJECTFILES}
	...
	gcc -fno-exceptions -fno-rtti -flto -Ofast -Wl,--hash-style=sysv -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/server -s ${OBJECTFILES} ${LDLIBSOPTIONS} 
