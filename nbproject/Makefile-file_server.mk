...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/server: ${OBJECTFILES}
	...
	gcc -fno-exceptions -fno-rtti -flto -Os -Wl,--gc-sections -m32 -Wl,--hash-style=sysv -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/server -s ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/examples/file_server.o: examples/file_server.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -s -DNO_AUTH -DNO_DEFLATE -DNO_INFO -DNO_LOG -DNO_SSL -MMD -MP -MF $@.d -o ${OBJECTDIR}/examples/file_server.o examples/file_server.cpp
