...
${OBJECTDIR}/_ext/1642614647/cr_event_loop.o: ../slite/src/third/libcrest/src/cr_event_loop.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -s -DNO_SSL -fno-exceptions -fno-rtti -flto -Ofast -m32 -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1642614647/cr_event_loop.o ../slite/src/third/libcrest/src/cr_event_loop.cpp
