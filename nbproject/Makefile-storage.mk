...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/server: ${OBJECTFILES}
	...
	g++ -fno-exceptions -fno-rtti -flto -Ofast -m32 -Wl,--hash-style=sysv -static-libstdc++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/server -s ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/examples/storage.o: examples/storage.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -s -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/examples/storage.o examples/storage.cpp
