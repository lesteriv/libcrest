...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/server: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/server ${OBJECTFILES} ${LDLIBSOPTIONS} -fno-exceptions -fno-rtti -flto -Ofast -m32 -Wl,--hash-style=sysv -static-libstdc++ -s
...
${OBJECTDIR}/examples/storage.o: examples/storage.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -s -DNO_SSL -fno-exceptions -fno-rtti -flto -Ofast -m32 -std=c++11 -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/examples/storage.o examples/storage.cpp
...
${OBJECTDIR}/third/mongoose/mongoose.o: third/mongoose/mongoose.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -s -DNO_SSL -fno-exceptions -fno-rtti -flto -Ofast -m32 -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/third/mongoose/mongoose.o third/mongoose/mongoose.cpp

${OBJECTDIR}/src/cr_thread_pool.o: src/cr_thread_pool.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -DNO_SSL -fno-exceptions -fno-rtti -flto -Ofast -m32 -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cr_thread_pool.o src/cr_thread_pool.cpp
