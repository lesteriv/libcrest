...
${OBJECTDIR}/src/cr_xml.o: src/cr_xml.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cr_xml.o src/cr_xml.cpp

${OBJECTDIR}/src/cr_connection.o: src/cr_connection.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cr_connection.o src/cr_connection.cpp

${OBJECTDIR}/examples/http_mirror.o: examples/http_mirror.cpp 
	${MKDIR} -p ${OBJECTDIR}/examples
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/examples/http_mirror.o examples/http_mirror.cpp

${OBJECTDIR}/src/cr_result.o: src/cr_result.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cr_result.o src/cr_result.cpp

${OBJECTDIR}/src/cr_string_map.o: src/cr_string_map.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cr_string_map.o src/cr_string_map.cpp

${OBJECTDIR}/third/zlib/trees.o: third/zlib/trees.cpp 
	${MKDIR} -p ${OBJECTDIR}/third/zlib
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/third/zlib/trees.o third/zlib/trees.cpp

${OBJECTDIR}/third/zlib/deflate.o: third/zlib/deflate.cpp 
	${MKDIR} -p ${OBJECTDIR}/third/zlib
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/third/zlib/deflate.o third/zlib/deflate.cpp

${OBJECTDIR}/src/cr_user_manager.o: src/cr_user_manager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cr_user_manager.o src/cr_user_manager.cpp

${OBJECTDIR}/src/crest.o: src/crest.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/crest.o src/crest.cpp

${OBJECTDIR}/src/cr_cache.o: src/cr_cache.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cr_cache.o src/cr_cache.cpp

${OBJECTDIR}/src/cr_utils.o: src/cr_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cr_utils.o src/cr_utils.cpp

${OBJECTDIR}/examples/storage.o: examples/storage.cpp 
	${MKDIR} -p ${OBJECTDIR}/examples
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/examples/storage.o examples/storage.cpp

${OBJECTDIR}/src/auth_digest.o: src/auth_digest.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/auth_digest.o src/auth_digest.cpp

${OBJECTDIR}/third/mongoose/mongoose.o: third/mongoose/mongoose.cpp 
	${MKDIR} -p ${OBJECTDIR}/third/mongoose
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/third/mongoose/mongoose.o third/mongoose/mongoose.cpp

${OBJECTDIR}/src/cr_thread_pool.o: src/cr_thread_pool.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cr_thread_pool.o src/cr_thread_pool.cpp
...
${OBJECTDIR}/examples/file_server.o: examples/file_server.cpp 
	${MKDIR} -p ${OBJECTDIR}/examples
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/examples/file_server.o examples/file_server.cpp
...
${OBJECTDIR}/src/auth_basic.o: src/auth_basic.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -s -fno-exceptions -fno-rtti -flto -Ofast -fvisibility=hidden -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/auth_basic.o src/auth_basic.cpp
